...
(function() {
  var Cloupp, ENDPOINT, File, HOST, SOCKET_IO_EP, SOCKET_IO_RES, Session, VERSION, io;
  ...
  Session = (function() {
    ...
    Session.prototype.compile = function() {
      ...
      this.socket.once('compiled', function(data) {
